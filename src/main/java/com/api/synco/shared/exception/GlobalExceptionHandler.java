package com.api.synco.shared.exception;

import com.api.synco.shared.api.CustomApiResponse;
import com.api.synco.shared.exception.token.TokenException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomApiResponse<?>> handleClassException(ClassDomainException e, HttpServletRequest httpServletRequest){
        ...
        HttpStatus status;
        if (e instanceof com.api.synco.module.class_entity.domain.exception.ClassNotFoundException) {
            status = HttpStatus.NOT_FOUND;
        } else if (e instanceof UserWithoutClassPermisionException) {
